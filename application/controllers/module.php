...
class Module extends MY_Controller {
	...
	public function index()
	{
		...
		*/
		...
		$this->load->view('head', array('page_title' => $data['title'], 'stylesheets' => array('layout_outer.css', 'layout_inner.css', 'theme.css'), 'scripts' => array('resource.js')));
	...
	public function view()
	{
		...
		{
			if (! is_string($this->uri->segment(3)) || ! is_numeric($this->uri->segment(4))) {
				$this->session->set_flashdata('error', 'Invalid module address. Addresses should be the course category/course number, joined by a slash (ag/101). This error was generated by module/view');
				redirect('module');
			}
		}
		else
		...
		if (! $data = $this->module_class->view(array('category' => $this->uri->segment(3), 'number' => $this->uri->segment(4))))
		{
