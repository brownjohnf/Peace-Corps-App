...
class Business extends MY_Controller {
	...
	{
		$this->defaultview_tags['navpath'][] = anchor('public/business/agribusiness','Agribusiness');
		$this->_print();
	}

	public function waste_management()
	{
		$this->defaultview_tags['navpath'][] = anchor('public/business/waste_management','Waste Management');
		$this->_print();
	}

	public function entrepreneurship()
	{
		$this->defaultview_tags['navpath'][] = anchor('public/business/entrepreneurship','Entrepreneurship');
		$this->_print();
	}
}