...
$data['splash'] = array(
					...
					array(
						  ...
						  'width' => '658px',
						  'title' => 'Congrats Aggies!',
						  'text' => "Peace Corps Senegal is proud to congratulate its latest training group as they take their oaths and swear-in as new Peace Corps Volunteers.",
						  'link' => anchor(base_url().'video/view/4/2011_Fall_Stage_Swears-In', 'Watch it inside', array('target' => '_blank'))
						  ),
					array(
